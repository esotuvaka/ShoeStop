    ...
    <footer id="Footer" role="contentinfo">
      <div className="relative bottom-0 border-t border-neutral-300 bg-white">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-4 py-14 md:grid-cols-3 md:px-8">
            ...
            <ul className="mt-8 space-y-4">
              <li className="text-sm font-medium text-gray-600 hover:text-gray-900">
                ...
                >
                  <svg
                    aria-hidden="true"
                    className="mr-3 fill-current text-gray-600"
                    width="26"
                    height="20"
                    viewBox="0 0 21 20"
                    fill="none"
          ...
          <div>
            <h2 className="text-md mb-4 font-medium uppercase">Templates</h2>
            <ul className="mt-8 space-y-4">
          ...
          <div>
            <h2 className="text-md mb-4 font-medium uppercase">Docs</h2>
            <ul className="mt-8 space-y-4">
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
