...
export default function Gallery() {
  ...
  return (
    <div
      className="no-scrollbar scroll-snap-x flex h-[485px] place-content-start gap-4 overflow-x-scroll scroll-smooth md:grid md:h-auto md:grid-cols-2"
      tabIndex="-1"
    >
      <Image
        fetchpriority="high"
        data={selectedVariant.image}
        className="md:flex-shrink-none h-full w-[80vw] flex-shrink-0 snap-start rounded-lg border border-gray-200 object-cover object-center md:col-span-2 md:h-auto md:w-full"
      />
      {galleryMedia.map((med) => {
        ...
        return (
          <MediaFile
            ...
            className="h-full w-[80vw] flex-shrink-0 snap-start rounded-lg border border-gray-200 object-cover object-center transition-all md:h-auto md:w-auto"
            data={med}
            fetchpriority="low"
            options={{
              height: '485',
